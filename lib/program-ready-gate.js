import { PROGRAM_GENERATION_FAILURE_REPLY, hasValidProgramList } from './program-validation.js';
...
export const PROGRAM_RECOVERY_REPLY = `${PROGRAM_GENERATION_FAILURE_REPLY} → Generate my school list`;

export function hasPrograms(programs) {
  return hasValidProgramList(programs);
}
