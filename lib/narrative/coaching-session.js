...
import { getSchoolNeeds, resolveSchoolSlug } from './school-portfolio-needs.js';
import { getEmploymentOutcomes } from './employment-outcomes.js';
...
export function isCoachingActive(candidateState = {}) {
  return !!candidateState?.narrativeCoaching?.sessionContext
    && candidateState?.narrativeCoaching?.strategy?.confirmationStatus !== 'confirmed'
    && candidateState?.strategy?.confirmationStatus !== 'confirmed';
}
