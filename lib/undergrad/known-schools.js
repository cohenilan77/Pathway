...
function scoreFit(profile, school, tier) {
...
// hasNCAATrackInterest, sizeTier, setting.
export function matchUndergradSchools(profile = {}) {
  ...
  const scored = pool.map(school => {
    ...
    return {
      ...
      tier,
      fit: scoreFit(profile, school, tier),
