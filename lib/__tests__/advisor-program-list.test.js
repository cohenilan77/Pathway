...
test('detects direct school-list generation and recovery requests', () => {
  ...
  assert.equal(requestsProgramList('list possible programs'), true);
  assert.equal(requestsProgramList('see my programs'), true);
  assert.equal(requestsProgramList('continue my analysis'), true);
