...
export const UNDERGRAD_TOOLS = [
  ...
  },
  {
    ...
    description: 'Save one factual profile field the student mentioned. Whitelisted fields only: grade, curriculum, gpa, subjects, activities, strongestActivity, leadership, awardsProjects, tests, intendedMajor, countries, universityStyle, pathwayType, interests, storySeeds.',
    input_schema: {
      type: 'object',
      properties: {
  ...
  },
  {
    ...
    description: 'The only way to reply to the student. Always call this last, exactly once, to end your turn.',
    input_schema: {
      type: 'object',
      properties: {
        message: { type: 'string' },
