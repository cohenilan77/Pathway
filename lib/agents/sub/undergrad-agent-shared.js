// Shared plumbing for the three Undergrad grade-band agents
// (UndergradExploreAgent, UndergradStrategyAgent, UndergradExecutionAgent).
// Each of those files owns its own grade-band voice/system prompt; this
// module only holds the mechanics they all need: the mandatory response
// rules, student-context formatting, and the forced respond_with_options
// tool call. Undergraduate-only — never imported outside lib/agents/sub/
// Undergrad*.js and lib/undergrad/deterministic-turn.js.
