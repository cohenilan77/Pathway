...
export function normalizeProfileFacts(profile = {}, scores = {}, raw = {}) {
  ...
  return {
    ...
    experience: {
      ...
      quantifiedImpact: array(profile.quantifiedImpact || profile.impactMetrics || profile.measurableImpact || profile.achievementsImpact || profile.experience?.quantifiedImpact),
