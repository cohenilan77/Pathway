...
export function normalizeProfileFacts(profile = {}, scores = {}, raw = {}) {
  ...
  const achievements = array(profile.achievements || profile.keyAchievements || profile.majorAchievements || profile.professionalAchievements || profile.experience?.achievements);
  ...
  const careerGoal = profile.careerGoal || profile.postDegreeRole || profile.postMbaGoal || profile.postMBAGoal || profile.targetRole || profile.goals?.career || null;
  ...
  return {
    ...
    narrative: {
      ...
      whyDegree: profile.whyDegree || profile.whyMBA || profile.mbaMotivation || profile.degreeMotivation || null,
      careerGoal,
