...
export const PATCH_FIELDS = new Set(['profile', 'scores', 'strengths', 'weaknesses', 'tasks', 'programs', 'chosenSchools', 'narrative', 'narrativeText', 'narrativeCoaching', 'strategy', 'documents', 'essays', 'interviews', 'calendarEvents', 'preferences', 'journeyStage', 'stepIdx', 'scholarships']);
