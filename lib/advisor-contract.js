...
export const PATCH_FIELDS = new Set(['profile', 'scores', 'strengths', 'weaknesses', 'tasks', 'programs', 'chosenSchools', 'narrative', 'documents', 'essays', 'interviews', 'calendarEvents', 'preferences', 'journeyStage', 'stepIdx']);
