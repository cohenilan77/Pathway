...
export const AGENT_IDS = [
  ...
  // Grad/MBA/PhD scholarship search agent — bound to BOTH tracks alongside
  // the Undergraduate smart agent's own tool-based scholarship lookup; see
  // lib/agents/sub/ScholarshipAgent.js.
  'scholarship',
  ...
  // Flag-gated (UNDERGRAD_SMART_AGENT) replacement for the 13-agent roster
  // above; see lib/agents/UndergradAgent.js.
  'undergradmaster',
  // Flag-gated (NARRATIVE_COACHING_V2) adversarial coaching session that
  // replaces the Pivot/Upgrade modal's generic chat handoff for grad/MBA/PhD/
  // Personal-Development candidates; see lib/agents/NarrativeCoachAgent.js.
  'narrativecoach',
];
