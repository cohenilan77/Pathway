...
programInfo definition: a school/program-specific strategic insight based on the LIVE KPI DATABASE, school/program facts, candidate profile, and candidate goals. It must answer why this program is strategically interesting for this specific candidate. It must include at least one real program angle such as PE/VC recruiting, deep-tech/AI/innovation ecosystem, alumni network, geographic recruiting advantage, faculty/lab/supervisor fit, portfolio/studio strength, law/medicine/research specialization, cohort selectivity, brand power in the candidate's target industry, funding/research alignment, entrepreneurship platform, or employer pipeline. It must connect that angle to the candidate's goal. Never make programInfo location-only, degree-type-only, selectivity-only, or generic; forbidden examples include "MBA relevance: New York, NY.", "Program relevance: MBA", "Good school for business", "Located in Boston", "Strong university", and "This is a competitive program".
