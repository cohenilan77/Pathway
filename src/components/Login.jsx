...
export default function Login({ role, setRole, showPw, setShowPw, remember, setRemember, go, forgot, login, adminAuth, authError, authBusy, showToast }) {
            ...
            <>
              <div className="auth__oauth-row">
                <button
                  ...
                  onClick={() => showToast && showToast('Google sign-in is coming soon.')}
                >
                ...
                <button
                  type="button"
                  className="auth__oauth-btn"
                  onClick={() => showToast && showToast('Outlook sign-in is coming soon.')}
                >
                  <svg width="18" height="18" viewBox="0 0 18 18">
