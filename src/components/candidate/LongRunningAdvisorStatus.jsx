...
export default function LongRunningAdvisorStatus({ busy, message, showDots = true }) {
  ...
  return (
    <span
      role="status"
      aria-live="polite"
      style={{ display: 'inline-flex', alignItems: 'center', gap: 9, minWidth: 0, fontSize: 12.5, fontWeight: 600, color: '#6b7392', lineHeight: 1.4, whiteSpace: 'nowrap', flexShrink: 0, animation: 'pwFade .25s ease' }}
    >
      {showDots && (
