    ...
    <div style={{ flex: 1, minHeight: 0, display: 'flex', flexDirection: 'column', padding: '24px 28px 28px' }}>
      <div className="pw-doc-grid" style={{ flex: 1, minHeight: 0, display: 'grid', gridTemplateColumns: '270px 1fr 290px', background: '#fff', borderRadius: 24, border: '1px solid #eef1f9', boxShadow: '0 18px 40px rgba(60,72,130,.06)', overflow: 'hidden' }}>
        ...
        <div style={{ borderRight: '1px solid #f0f2fa', display: 'flex', flexDirection: 'column', overflowY: 'auto' }}>
          <div style={{ padding: '20px 16px 14px', borderBottom: '1px solid #f0f2fa' }}>
          ...
          <div style={{ padding: 18, flex: 1 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '10px 14px', borderRadius: 13, background: cvText ? '#eafdf6' : '#f7f9fe', border: `1px solid ${cvText ? '#a9eed1' : '#ecf0fa'}` }}>
                <span style={{ width: 8, height: 8, borderRadius: '50%', background: cvText ? '#19c08a' : '#c7cce3', flexShrink: 0 }} />
                <div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '10px 14px', borderRadius: 13, background: essayText ? '#eafdf6' : '#f7f9fe', border: `1px solid ${essayText ? '#a9eed1' : '#ecf0fa'}` }}>
                <span style={{ width: 8, height: 8, borderRadius: '50%', background: essayText ? '#19c08a' : '#c7cce3', flexShrink: 0 }} />
                <div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '10px 14px', borderRadius: 13, background: insights ? '#eafdf6' : '#f7f9fe', border: `1px solid ${insights ? '#a9eed1' : '#ecf0fa'}` }}>
                <span style={{ width: 8, height: 8, borderRadius: '50%', background: insights ? '#19c08a' : '#c7cce3', flexShrink: 0 }} />
                <div>
        ...
        {/* Main content */}
        <div style={{ background: '#f7f9fe', padding: 40, overflowY: 'auto', display: 'flex', justifyContent: 'center', alignItems: 'flex-start' }}>
          {docTab === 'editor' && (
            <div style={{ background: '#fff', maxWidth: 580, width: '100%', borderRadius: 20, boxShadow: '0 18px 40px rgba(60,72,130,.08)', padding: '44px 48px', minHeight: 600, border: '1px solid #eef1f9' }}>
                  ...
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
                    {savedSchools.map(school => (
                      <button key={school} onClick={() => selectEssaySchool(school)}
                        style={{
                          background: essaySchool === school ? 'linear-gradient(135deg,#4d83ff,#8a52ff)' : '#fff',
                          color: essaySchool === school ? '#fff' : '#141b34',
                          border: essaySchool === school ? 'none' : '1.5px solid #ecf0fa', borderRadius: 12, padding: '7px 14px',
              ...
              <div style={{ marginBottom: 20 }}>
                ...
                <input
                  ...
                  style={{ width: '100%', border: '1.5px solid #ecf0fa', borderRadius: 12, padding: '10px 14px', fontSize: 14, fontFamily: 'inherit', outline: 'none', color: '#141b34', boxSizing: 'border-box', background: '#f7f9fe' }}
                />
              </div>
              ...
              <div style={{ marginBottom: 20 }}>
                ...
                <textarea
                  ...
                  style={{ width: '100%', minHeight: 60, border: '1.5px solid #ecf0fa', borderRadius: 12, padding: '10px 14px', fontSize: 14, fontFamily: 'inherit', outline: 'none', color: '#141b34', boxSizing: 'border-box', resize: 'vertical', lineHeight: 1.5, background: '#f7f9fe' }}
                />
              </div>
              ...
              {essayText ? (
                <textarea
                  ...
                  style={{ width: '100%', minHeight: 380, border: '1.5px solid #ecf0fa', borderRadius: 14, padding: '16px', fontSize: 15, lineHeight: 1.8, color: '#33405e', fontFamily: 'inherit', resize: 'vertical', outline: 'none', boxSizing: 'border-box', background: '#f7f9fe' }}
                />
              ) : (
                <div style={{ minHeight: 380, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', border: '2px dashed #dde2f3', borderRadius: 14, padding: 32, textAlign: 'center' }}>
                  ...
                  <button
                    ...
                    style={{ background: 'linear-gradient(135deg,#4d83ff,#8a52ff)', color: '#fff', border: 'none', borderRadius: 13, padding: '11px 22px', fontSize: 14, fontWeight: 700, cursor: 'pointer', fontFamily: 'inherit', boxShadow: '0 10px 20px rgba(105,91,255,.32)' }}>
                    Start Writing →
                  </button>
                </div>
              )}
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
                ...
                {cvText ? (
                  <div style={{ display: 'flex', gap: 10 }}>
                    {cvFile && (
                      <button onClick={downloadOriginalCv}
                        style={{ background: '#fff', border: '1.5px solid #ecf0fa', borderRadius: 12, padding: '9px 18px', fontSize: 13, fontWeight: 600, color: '#141b34', cursor: 'pointer', fontFamily: 'inherit' }}>
                        Original
                      </button>
                    )}
                    {!editingCv ? (
                      ...
                      <>
                        <button onClick={() => setEditingCv(false)}
                          style={{ background: 'none', border: '1.5px solid #ecf0fa', borderRadius: 12, padding: '9px 18px', fontSize: 13, fontWeight: 600, color: '#6b7392', cursor: 'pointer', fontFamily: 'inherit' }}>
                          Cancel
                        </button>
                        <button onClick={() => { setCvText(cvEdit); setEditingCv(false); showToast('CV saved.'); }}
                          style={{ background: 'linear-gradient(135deg,#4d83ff,#8a52ff)', color: '#fff', border: 'none', borderRadius: 12, padding: '9px 18px', fontSize: 13, fontWeight: 700, cursor: 'pointer', fontFamily: 'inherit', boxShadow: '0 8px 16px rgba(105,91,255,.3)' }}>
                          Save
                        </button>
                      </>
                    )}
                  ...
                  <button onClick={() => setShowCvModal(true)}
                    style={{ background: 'linear-gradient(135deg,#4d83ff,#8a52ff)', color: '#fff', border: 'none', borderRadius: 12, padding: '10px 20px', fontSize: 13, fontWeight: 700, cursor: 'pointer', fontFamily: 'inherit', boxShadow: '0 8px 16px rgba(105,91,255,.3)' }}>
                    + Upload CV
                  </button>
                )}
              </div>
              {cvText ? (
                editingCv ? (
                  <textarea
                    ...
                    style={{ width: '100%', minHeight: 500, border: '1.5px solid #ecf0fa', borderRadius: 14, padding: '20px', fontSize: 14, fontFamily: 'inherit', lineHeight: 1.7, color: '#141b34', resize: 'vertical', outline: 'none', boxSizing: 'border-box', background: '#f7f9fe' }}
                  />
                ) : (
                  <div style={{ background: '#fff', borderRadius: 16, border: '1px solid #eef1f9', padding: '28px 32px', whiteSpace: 'pre-wrap', fontSize: 14, lineHeight: 1.8, color: '#33405e', fontFamily: 'inherit', minHeight: 400, boxShadow: '0 18px 40px rgba(60,72,130,.06)' }}>
                    {cvText}
                  </div>
                )
              ) : (
                <div style={{ background: '#fff', borderRadius: 16, border: '2px dashed #dde2f3', padding: 48, textAlign: 'center' }}>
                  <div style={{ fontSize: 14.5, color: '#9098b5', marginBottom: 18, lineHeight: 1.6 }}>
                    No CV uploaded yet. Paste your CV to unlock profile analysis and personalized strategy.
                  </div>
                  <button onClick={() => setShowCvModal(true)}
                    style={{ background: 'linear-gradient(135deg,#4d83ff,#8a52ff)', color: '#fff', border: 'none', borderRadius: 13, padding: '13px 26px', fontSize: 14, fontWeight: 700, cursor: 'pointer', fontFamily: 'inherit', boxShadow: '0 10px 20px rgba(105,91,255,.32)' }}>
                    Paste My CV →
                  </button>
                </div>
              )}
              ...
              {interviewSchools.length > 0 ? (
                <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                  {interviewSchools.map(school => {
                    ...
                    return (
                      <div key={school} style={{ background: '#fff', borderRadius: 16, border: '1px solid #eef1f9', padding: '20px 22px', boxShadow: '0 18px 40px rgba(60,72,130,.06)' }}>
                        ...
                        {result ? (
                          <>
                            ...
                            <button onClick={() => startInterview(school)}
                              style={{ marginTop: 14, background: 'none', border: '1.5px solid #ecf0fa', color: '#5b46e0', borderRadius: 12, padding: '9px 16px', fontSize: 13, fontWeight: 700, cursor: 'pointer', fontFamily: 'inherit' }}>
                              Redo Interview →
                            </button>
                          </>
                        ) : (
                          <button onClick={() => startInterview(school)}
                            style={{ marginTop: 6, background: 'linear-gradient(135deg,#4d83ff,#8a52ff)', color: '#fff', border: 'none', borderRadius: 12, padding: '10px 18px', fontSize: 13, fontWeight: 700, cursor: 'pointer', fontFamily: 'inherit', boxShadow: '0 8px 16px rgba(105,91,255,.3)' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                  {insights.map((item, i) => (
                    <div key={i} style={{
                      ...
                      <div style={{ fontSize: 11, fontWeight: 800, letterSpacing: '.5px', color: item.type === 'strength' ? '#19c08a' : '#c77f0a', marginBottom: 6, textTransform: 'uppercase' }}>
                  ...
                  <button onClick={() => analyzeEssay()} disabled={busy}
                    style={{ marginTop: 8, background: 'linear-gradient(135deg,#4d83ff,#8a52ff)', color: '#fff', border: 'none', borderRadius: 14, padding: '14px', fontSize: 14, fontWeight: 700, cursor: busy ? 'not-allowed' : 'pointer', fontFamily: 'inherit', opacity: busy ? 0.6 : 1, boxShadow: '0 10px 20px rgba(105,91,255,.32)' }}>
                    Re-analyze Essay
                  </button>
                </div>
              ) : (
        ...
        <div style={{ borderLeft: '1px solid #f0f2fa', background: '#fbfcfe', overflowY: 'auto', display: 'flex', flexDirection: 'column' }}>
          <div style={{ background: '#f3f5fc', padding: 20, borderBottom: '1px solid #edf0f9' }}>
          ...
          <div style={{ padding: '20px 20px', flex: 1 }}>
            {docTab === 'editor' && essayText && (
              <>
                <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 12, fontWeight: 700, color: '#141b34', marginBottom: 8 }}>
                  WORD COUNT <span style={{ color: wordCount > 1000 ? '#e0457a' : '#6b7392' }}>{wordCount} / 1000</span>
                </div>
                <div style={{ height: 6, background: '#eef0f9', borderRadius: 3, marginBottom: 24, overflow: 'hidden' }}>
                  <div style={{ width: `${Math.min(essayPct, 100)}%`, height: '100%', background: wordCount > 1000 ? '#e0457a' : 'linear-gradient(90deg,#4d83ff,#8a52ff)' }} />
                </div>
              </>
            )}
            ...
            {insights && insights.slice(0, 2).map((item, i) => (
              <div key={i} style={{
                ...
                <div style={{ fontSize: 11, fontWeight: 800, color: item.type === 'strength' ? '#19c08a' : '#c77f0a', marginBottom: 5, textTransform: 'uppercase' }}>
          ...
          <div style={{ padding: '0 20px 20px', display: 'flex', flexDirection: 'column', gap: 10 }}>
            {essayText && (
              <>
                <button onClick={() => analyzeEssay()} disabled={busy}
                  style={{ width: '100%', background: 'none', border: '1.5px solid #ecf0fa', color: '#5b46e0', borderRadius: 13, padding: 13, fontSize: 13, fontWeight: 700, cursor: busy ? 'not-allowed' : 'pointer', fontFamily: 'inherit', opacity: busy ? 0.5 : 1 }}>
                  ✦ Analyze with AI
                </button>
                <button onClick={() => rewriteEssay()} disabled={busy}
                  style={{ width: '100%', background: 'linear-gradient(135deg,#4d83ff,#8a52ff)', color: '#fff', border: 'none', borderRadius: 13, padding: 13, fontSize: 13, fontWeight: 700, cursor: busy ? 'not-allowed' : 'pointer', fontFamily: 'inherit', opacity: busy ? 0.5 : 1, boxShadow: '0 10px 20px rgba(105,91,255,.32)' }}>
            ...
            {!cvText && (
              <button onClick={() => setShowCvModal(true)}
                style={{ width: '100%', background: 'linear-gradient(135deg,#ffb35c,#ff7a9c)', color: '#fff', border: 'none', borderRadius: 13, padding: 13, fontSize: 13, fontWeight: 700, cursor: 'pointer', fontFamily: 'inherit', boxShadow: '0 10px 20px rgba(255,122,156,.32)' }}>
                Upload CV →
              </button>
            )}
          </div>
