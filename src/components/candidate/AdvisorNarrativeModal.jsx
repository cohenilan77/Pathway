  ...
  return (
    <div onClick={onClose} style={{ position: 'absolute', inset: 0, background: 'rgba(20,27,52,.58)', zIndex: 20, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
      <div className="pw-narrative-modal-shell" onClick={e => e.stopPropagation()} style={{ position: 'relative', background: '#fff', borderRadius: 16, maxWidth: 640, width: '100%', padding: 32, boxShadow: '0 30px 60px rgba(20,27,52,.35)', maxHeight: '90vh', overflowY: 'auto' }}>
        ...
        <h2 style={{ fontFamily: "'Newsreader',serif", fontSize: 26, fontWeight: 700, color: '#141b34', margin: '0 0 10px' }}>Choose your narrative</h2>
        ...
        <div className="pw-narrative-modal-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 22 }}>
          <div style={{ background: '#fff', border: '1px solid #e8ecf6', borderRadius: 14, padding: 20, display: 'flex', flexDirection: 'column', gap: 10 }}>
            ...
            <h3 style={{ fontFamily: "'Newsreader',serif", fontSize: 18, fontWeight: 700, color: '#141b34', margin: 0 }}>The Upgrade</h3>
            ...
            <button onClick={() => onChoose('upgrade')} style={{ width: '100%', background: '#141b34', color: '#fff', border: 'none', borderRadius: 9, padding: '12px 0', fontSize: 13.5, fontWeight: 700, cursor: 'pointer', fontFamily: 'inherit', boxShadow: '0 8px 18px rgba(22,35,63,.26)' }}>Choose the Upgrade</button>
          </div>
          <div style={{ background: '#fff', border: '1px solid #e8ecf6', borderRadius: 14, padding: 20, display: 'flex', flexDirection: 'column', gap: 10 }}>
            <span style={{ alignSelf: 'flex-start', fontSize: 12, fontWeight: 800, letterSpacing: '.6px', color: '#e0556b', background: '#fdeaf0', padding: '4px 9px', borderRadius: 7 }}>HIGHER REWARD</span>
            <span style={{ fontSize: 22 }}>🔄</span>
            <h3 style={{ fontFamily: "'Newsreader',serif", fontSize: 18, fontWeight: 700, color: '#141b34', margin: 0 }}>The Pivot</h3>
